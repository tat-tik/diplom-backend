...
8. Переходим в папку backstore и устанавливаем виртуальное окружение:  
**python3 -m venv env**  
Активируем виртуальное окружение:  
**source env/bin/activate**

9. Устанавливаем все зависимости из файла requirements.txt  
**pip install -r requirements.txt**

10. Делаем миграции:  
**python manage.py migrate**

11. Создаем файл настроек gunicorn:  
...
13. Настраиваем файл конфигурации сервера:  
...
14. Создаем ссылку **sudo ln -s /etc/nginx/sites-availeble/backstore etc/nginx/sites-enable**

15. Перезапускаем nginx **sudo systemctl reload nginx**

16. В файле настроек **/etc/nginx/nginx.conf**, необхожимо отключить проверку размера тела запроса с клиента, для возможности отправки на сервер больших файлов. Добавьте в конец блока http {} файла конфигурации строчку: **client_max_body_size 0**;

17. Разрешите полные права для Nginx: **sudo ufw allow 'Nginx Full'**

18. Чтобы не было конфликтов удалим default - стандартную конфигурацию Nginx, которая создаётся при установке:  
**sudo rm /etc/nginx/sites-enabled/default**

19. Для обновления рабочей конфигурации перезапустите веб-сервер Nginx:  
**sudo systemctl reload nginx**

20. Перейдите к разворачиванию frontend на сервере. 
Инструкция по разворачиванию находится в файле READEME.md в корне проекта frontend.